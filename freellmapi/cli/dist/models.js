...
export function contextWindowOf(model) {
 ...
 */
export function resolveLaunchModel(requested, available, full = available) {
    ...
    if (!known) {
        ...
        const suggestions = full
            ...
            .slice(0, 5);
        throw new UnknownModelError(`No model '${id}' in this gateway's catalog.`
